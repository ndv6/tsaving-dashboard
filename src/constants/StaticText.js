...
export const DASHBOARD_CASH_FLOW_MAIN = DASHBOARD_CASH_FLOW_TITLE + " to " + MAIN_ACCOUNT
export const DASHBOARD_CASH_FLOW_VA = DASHBOARD_CASH_FLOW_TITLE + " to " + VIRTUAL_ACCOUNT
