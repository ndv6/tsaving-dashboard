  ...
  return (
    <div className="dashboard-constraint">
      ...
      <div className="dashboard-content">
        {state.err ? (
          <h1 className="err-msg">{FAILED_TO_FETCH_DATA}</h1>
        ) : (
          [
            <div
                          ...
                          : [
                              <div className="dashboard-content-chart-card">
                                <ComponentChartCard
                                  ...
                                  title={
                                    <h3>{DASHBOARD_NUM_USER_YESTERDAY}</h3>
                                  }
                                  contentHeight={36}
                                  total={
                                    <h4>
                                ...
                                <ComponentChartCard
                                  ...
                                  total={
                                    <h4>
                                      {data.data.dashboard_user.new_user_today +
                                        DASHBOARD_USER_ACQUIRE}
                                    </h4>
                                  }
                                  content={
                                    data.data.dashboard_user
                                      .new_user_yesterday <= 0 ? (
                                      ''
                                    ) : (
                                      <p>
                                        {data.data.dashboard_user
                ...
                <ComponentCard
                  ...
                  content={
                    state.loading
                      ? []
                      : transactionChart(
                          state.err ? null : data.data.dashboard_transaction,
                        )
                  }
                />
              </Fade>
                  ...
                  content={
                    state.loading
                      ...
                      : [
                          <div className="dashboard-content-chart">
                            <div className="dashboard-content-left">
                              {transactionComponentUI(
                                data.data.dashboard_amount.transaction_month,
                              )}
                            </div>
                            <div className="dashboard-content-right">
                              {[
                                <div className="dashboard-content-chart-card">
                                  <ComponentChartCard
                                    className="dashboard-chart-card"
                                    title={
                                      <h3>{DASHBOARD_CASH_FLOW_YESTERDAY}</h3>
                                    }
                                    contentHeight={36}
                                    total={
                                      <h4>
                                        {formatter.format(
                                          data.data.dashboard_amount
                                            .total_transaction_yesterday,
                                        ) + DASHBOARD_CASH_FLOW}
                                      </h4>
                                    }
                                  />
                              ...
                              <ComponentChartCard
                                ...
                                total={
                                  <h4>
                                    {formatter.format(
                                      data.data.dashboard_amount
                                        .total_transaction_amount_deposit,
                                    ) + DASHBOARD_CASH_FLOW}
                                  </h4>
                                }
                              />
